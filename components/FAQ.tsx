export default function FAQ() {
  return (
    <section className="py-20 bg-picmi-bg">
      <div className="max-w-3xl mx-auto px-4">
        <h2 className="text-4xl font-extrabold mb-12 text-center uppercase border-b-4 border-picmi-primary inline-block pb-2 px-8">
          Questions ?
        </h2>
        <div className="space-y-6">
          <details className="bg-white border-2 border-black shadow-hard group open:bg-picmi-primary open:shadow-none open:translate-x-[4px] open:translate-y-[4px] transition-all duration-200 rounded-xl">
            <summary className="list-none flex justify-between items-center p-6 cursor-pointer font-bold text-xl">
            ...
            <div className="px-6 pb-6 pt-0 font-medium text-lg leading-relaxed">
