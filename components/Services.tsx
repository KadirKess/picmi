  ...
  return (
    <section className="py-20 px-4 md:px-8 bg-picmi-bg" id="services">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-5xl md:text-7xl font-extrabold text-black mb-16 text-center md:text-left drop-shadow-sm">
          NOS{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[320px]">
          {/* Mariages Card */}
          <div className="md:col-span-2 row-span-1 md:row-span-2 relative group rounded-2xl border-2 border-black bg-picmi-cream shadow-hard overflow-hidden hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-hard-sm transition-all duration-200">
            ...
            />
            <div className="absolute bottom-0 left-0 w-full bg-picmi-cream/95 backdrop-blur-sm border-t-2 border-black p-8">
              <h3 className="text-3xl font-extrabold uppercase mb-2">Mariages</h3>
          ...
          {/* Soirées Card */}
          <div className="relative group rounded-2xl border-2 border-black bg-picmi-accent shadow-hard overflow-hidden flex flex-col justify-between hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-hard-sm transition-all duration-200">
            <div className="p-8">
              <span className="material-icons text-5xl mb-6 border-2 border-black bg-white rounded-full p-3 shadow-hard-sm text-black">
                celebration
              </span>
              <h3 className="text-2xl font-extrabold uppercase">Soirées</h3>
          ...
          {/* Pro Card */}
          <div className="relative group rounded-2xl border-2 border-black bg-picmi-primary shadow-hard overflow-hidden flex flex-col hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-hard-sm transition-all duration-200">
            <div className="p-8 flex-grow">
              <span className="material-icons text-5xl mb-6 border-2 border-black bg-white rounded-full p-3 shadow-hard-sm text-black">
                work_outline
              </span>
              <h3 className="text-2xl font-extrabold uppercase">Pro</h3>
              <p className="font-medium mt-3 text-gray-800">
          ...
          <div className="md:col-span-3 relative group rounded-2xl border-2 border-black bg-white shadow-hard overflow-hidden flex flex-col md:flex-row hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-hard-sm transition-all duration-200">
            <div className="md:w-1/2 bg-picmi-bg flex items-center justify-center border-b-2 md:border-b-0 md:border-r-2 border-black p-10">
              <div className="relative w-3/4 h-56 rounded-xl overflow-hidden border-2 border-black shadow-hard-sm">
                 <Image
            ...
            <div className="md:w-1/2 p-10 flex flex-col justify-center bg-picmi-cream">
              <h3 className="text-3xl font-extrabold uppercase mb-6">
                Qualité Studio
              </h3>
